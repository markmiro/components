...
const AllComponents = ({scale = 1, elementStateClass}) => (
	<VerticalSpacer space=".5em" style={{fontSize: `${scale*100}%`, flexGrow: scale*10}}>
		<VerticalSpacer space="1em">
			...
			<div>
				...
				<InputMessage className={elementStateClass}>This is something</InputMessage>
			</div>
			<div>
				<Label status="error" className={elementStateClass}>First Name</Label>
				<Input status="error" className={elementStateClass} value={LOREM_TEXT} />
				<InputMessage status="error" className={elementStateClass}>This is something</InputMessage>
			</div>
			<div>
				<Label status="warning" className={elementStateClass}>First Name</Label>
				<Input status="warning" className={elementStateClass} value={LOREM_TEXT} />
				<InputMessage status="warning" className={elementStateClass}>This is something</InputMessage>
			</div>
			<div>
				<Label status="success" className={elementStateClass}>First Name</Label>
				<Input status="success" className={elementStateClass} value={LOREM_TEXT} />
				<InputMessage status="success" className={elementStateClass}>This is something</InputMessage>
			</div>
		</VerticalSpacer>
		<br />
		<Loading />
		...
		<FinePrint>
			Lorem ipsum dolor sit amet, consectetur <a href="#">adipisicing elit</a>. Totam porro temporibus ullam, explicabo optio corporis sit repellat veniam atque fugiat consequatur nisi tempore, suscipit reprehenderit deserunt ipsum fugit, at aliquid!
		</FinePrint>
	</VerticalSpacer>
);
...
storiesOf('Animations', module)
	.add('TransitionExample', () => (
		<TransitionExample />
	))
	.add('TransitionContentExample', () => (
		<TransitionContentExample />
	));
		...
		<VerticalSpacer space="2em">
			...
			<HSpacer space="2em">
				...
				<VerticalSpacer space=".2em">
					...
					<FinePrint>Add more weight to bottom of title by having 3 words</FinePrint>
					<br />
					<Label>Two-letter word at the end</Label>
					<Box width="10.1em">
						The Kardashians continuously infiltrate&nbsp;it
