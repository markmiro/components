...
const Background = styled.div`
	background-color: ${chroma(MAIN_COLOR).alpha(0.01).css()};
`;
...
const List = styled.ul`
	...
	li + li {
		padding-top: 0.4em;
		border-top: 1px solid ${chroma(MAIN_COLOR).alpha(0.2).css()};
	}
`;
...
const JobAndTitle = ({ job, title = '', started, ended = 'Present' }) => [
	<Job>{job}</Job>,
	<Small>{title && title + ' '}({started} — {ended})</Small>,
];
		...
		<Container>
			<Grid>
				...
				<GridArea value="zetta-job">
					<List>
						<li>
							In our biggest deals my UI work was mentioned as one of the<Br />deciding factors for choosing us
						</li>
						<li>
						...
						<li>
							<Small>
								Drove all the front-end archituctural decisions • Was the point-person when boss was on vacation •<Br />Ran and initiated usability tests and user interviews • Gave several company-wide presentaions
							</Small>
						</li>
					</List>
				</GridArea>
				...
				<GridArea value="ask-ziggy-job">
					Created prototype apps that integrated voice and gesture to help answer<Br />what the next generation of human-computer interaction looks like
					<Small>
						Also interviewed tech talent and ran user tests
					</Small>
				</GridArea>
				...
				<GridArea value="mini-job">
					<FlexRow>
						...
						<Small style={{ marginTop: '0.7em' }}>
							Redesigned the website and created a custom Wordpress template for it •<Br />The website moved up to #1 in Google for “transportation studies” as a result<Br />(but no longer) • The template was later used in 4 additional departments
						</Small>
						</Column>
						...
						<Column>
							...
							/>
							<Small style={{ marginTop: '0.7em' }}>
								Made websites in Flash • Fixed major bugs that<Br />impacted almost a quarter million users
							</Small>
						</Column>
					</FlexRow>
				</GridArea>
